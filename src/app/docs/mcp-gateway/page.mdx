...
> One endpoint — `https://hypermove.duckdns.org/api/mcp` — makes cross-chain web3 agent-callable.
...
**[hypermove.duckdns.org/mcp-connect](/mcp-connect)** is the fastest path:
...
curl https://hypermove.duckdns.org/api/mcp/spec     # OpenAPI-3.1-style super spec
```
