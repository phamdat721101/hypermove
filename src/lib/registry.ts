...
export const PROTOCOLS: readonly Protocol[] = [
  { id: 'x402',            name: 'x402',                 summary: 'HTTP 402 + WWW-Authenticate handshake',           chains: ['base-mainnet','base-sepolia','xrpl-mainnet','xrpl-testnet','goat-mainnet','arbitrum-mainnet','optimism-mainnet'], accent: 'primary' },
