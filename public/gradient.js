(function(){
if(window.__gradientInstance){try{window.__gradientInstance.initGradient("#gradient-canvas")}catch(e){}return;}
/*
 ...
 */
var gradient = new Gradient();window.__gradientInstance=gradient;
